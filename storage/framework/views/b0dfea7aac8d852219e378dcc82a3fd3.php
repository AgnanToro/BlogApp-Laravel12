...
<?php $__env->startSection('title', 'BlogSpace - Share Your Stories'); ?>
...
<section class="py-8 bg-white border-b border-gray-200">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-6">
            ...
            <!-- Search Form -->
            <form method="GET" action="<?php echo e(route('posts.index')); ?>" class="max-w-md mx-auto mb-6" id="search-form">
                <div class="relative">
                    <input type="text" name="q" id="search-input" value="<?php echo e(request('q')); ?>" placeholder="Cari artikel..." 
                           autocomplete="off"
        ...
        <?php if(isset($keyword) && $keyword): ?>
            <div class="mb-8 text-center">
                <span class="text-gray-700">Hasil pencarian untuk: <span class="font-semibold text-blue-600">"<?php echo e($keyword); ?>"</span></span>
            </div>
        <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="bg-white rounded-2xl shadow-lg overflow-hidden card-hover border border-gray-100 flex flex-col h-full">
                        ...
                        <div class="relative">
                            <?php if($post->foto): ?>
                                <img src="<?php echo e(asset('storage/' . $post->foto)); ?>" alt="Foto Artikel" class="w-full h-48 object-cover object-center">
                            <?php else: ?>
                                <div class="h-48 flex items-center justify-center" style="background-color: #1e40af;">
                                    <div class="text-center">
                                        ...
                                        <p style="color: #ffffff; font-size: 0.875rem; font-weight: 500;"><?php echo e(Str::limit($post->judul, 30)); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="p-6 flex-1 flex flex-col">
                            <div class="flex-1 flex flex-col">
                                ...
                                <div class="flex items-center text-sm text-gray-500 mb-3">
                                    ...
                                    <span><?php echo e($post->tanggal_post->translatedFormat('d F Y')); ?></span>
                                    <?php if($post->user): ?>
                                ...
                                <h3 class="text-xl font-bold text-gray-900 mb-3 leading-tight hover:text-blue-600 transition-colors">
                                    <a href="<?php echo e(route('posts.show', $post)); ?>"><?php echo e($post->judul); ?></a>
                                </h3>
                                <!-- Excerpt -->
                                <p class="text-gray-600 text-sm leading-relaxed mb-4">
                                    <?php echo e(Str::limit($post->konten, 100)); ?>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                <div class="flex items-center text-sm text-gray-500 h-6">
                                    ...
                                    <span class="leading-none"><?php echo e($post->comments->count()); ?> comments</span>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\NGODING\Dafidea - testcase\resources\views/posts/index.blade.php ENDPATH**/ ?>