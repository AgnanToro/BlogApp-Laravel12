...
<div class="row mt-4">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('penulis.posts.update', $post) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('penulis.posts') }}" class="btn btn-secondary">Kembali</a>
    ...
    <div class="col-md-4">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <a href="{{ route('posts.show', $post) }}" class="btn btn-info btn-sm" target="_blank">View Post</a>
