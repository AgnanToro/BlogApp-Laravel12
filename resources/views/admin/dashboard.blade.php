...
<div class="row mb-4">
    <div class="col-12">
        <div class="card card-modern bg-gradient" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            <div class="card-body text-white">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h2 class="fw-bold mb-2 text-primary">Selamat Datang, Admin!</h2>
                        <p class="mb-0 text-primary">Kelola blog Anda dengan mudah dan profesional</p>
                    </div>
