...
@section('title', 'Kelola Posts - Admin BlogSpace')
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" style="gap:0.4rem;">
                                        <a href="{{ route('admin.posts.show', $post) }}" class="btn btn-sm btn-outline-info" style="margin-right:2px;">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.posts.edit', $post) }}" class="btn btn-sm btn-outline-warning" style="margin-right:2px;">
